...
import { AiFillFacebook, AiFillInstagram, AiOutlineTwitter, AiFillLinkedin, AiFillYoutube, AiFillGithub, AiOutlineArrowUp } from 'react-icons/ai';
const Footer = () => {
  return (
      ...
      <div className='grid md:grid-cols-3 md:grid-rows-1 grid-cols-2 grid-rows-2'>
        <div className='space-y-4 col-start-1'>
          ...
          <p className='md:w-[244px] text-xs opacity-40 font-sf'>
            Welcome to SLIIT FOSS community. We&apos;re a group of volunteers who believe in the usage of Free/Open Source Software (FOSS)
          </p>
