        ...
        <div className="my-10 grid grid-cols-[270px_104px_270px] justify-center" key={index}>
          <div
            className={`items-center grid ${
              index % 2 == 0 ? "md:order-2 place-items-end" : "md:order-4 place-items-end md:place-items-start"
            }`}
          >
          ...
          <div className={index % 2 == 0 ? "text-start order-4" : "place-items-end text-start md:text-end order-2"}>
